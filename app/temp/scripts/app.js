...
var reveal = new _RevealScroll2.default();
...
var RevealScroll = function () {
	function RevealScroll() {
		...
		this.scroll = (0, _jquery2.default)('.site-header__scroll');
		this.events();
	}
	...
	_createClass(RevealScroll, [{
		...
		value: function hideScroll() {
			(0, _jquery2.default)(document).scroll(function () {
				var scroll = (0, _jquery2.default)('.site-header__scroll');
				if ((0, _jquery2.default)(window).scrollTop() === 0) scroll.fadeOut();
			});
		}
	}, {
		key: 'showScroll',
		value: function showScroll() {
			(0, _jquery2.default)(document).scroll(function () {
				var scroll = (0, _jquery2.default)('.site-header__scroll');
				if ((0, _jquery2.default)(window).scrollTop() !== 0) scroll.fadeIn();
			});
		}
	}]);
